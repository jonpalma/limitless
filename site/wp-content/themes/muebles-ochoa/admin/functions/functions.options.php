...
$of_options[] = array( 	"name" 		=> "Middle Header Custom Code"
						...
						,"std" 		=> '[one_half][banner link_url="#" title="oswad market" bg_image="http://demo2.wpdance.com/imgs/WP_Woo_OswadMarket/header-banner-1-bg.jpg" bg_color="#ffffff" bg_hover="#64921d" bg_text="http://demo2.wpdance.com/imgs/WP_Woo_OswadMarket/header-banner-1-text.png" position_text_bottom="17px" show_label="no" label_text="save off" label_style="big onsale two_word" responsive="max_much_width"][/one_half][one_half_last][banner link_url="#" title="oswad market" bg_image="http://demo2.wpdance.com/imgs/WP_Woo_OswadMarket/header-banner-2-bg.jpg" bg_color="#ffffff" bg_hover="#64921d" bg_text="http://demo2.wpdance.com/imgs/WP_Woo_OswadMarket/header-banner-2-text.png" position_text_bottom="17px" show_label="no" label_text="save off" label_style="big onsale two_word" responsive="max_much_width"][/one_half_last]'
