		...
		<div class="wd_tini_account_wrapper">
			<div class="wd_tini_account_control">
				<?php if(!$_user_logged):?>
					...
					<a class="sign-in-form-control" href="<?php echo $login_url;?>" title="<?php _e('Ingresar','wpdance');?>">
						<span><?php _e('Ingresar','wpdance');?></span>
					</a>
					<span class="visible-phone login-drop-icon"></span>				
				<?php else:?>		
					<a href="<?php echo $profile_url; ?>" title="<?php _e('Mi Cuenta','wpdance'); ?>">
						<?php _e('Mi Cuenta','wpdance'); ?>
					</a>	
				<?php endif;?>
				<?php if( !$_user_logged ):?>
				<div class="regis-account-wrapper">
					<span>&nbsp;<?php _e('/','wpdance');?></span>
					<a class="" href="<?php echo $register_url;?>" title="<?php _e('Crear Cuenta','wpdance');?>">
						<span><?php _e('Registrarse','wpdance');?></span>
					</a>	
				</div>
				<?php endif; ?>
			</div>
						...
						<div class="form_wrapper_body">
							<?php    
								$args = array(
									...
									,'label_username' => __( 'Usuario','wpdance' )
									,'label_password' => __( 'Contraseña','wpdance' )
									,'label_remember' => __( '','wpdance' )
									,'label_log_in' => __( 'Ingresar','wpdance' )
									,'remember' => false
								);
								wp_login_form( $args );
							?>
							<span class="required"><?php _e('* Required','wpdance');?></span>
							<a href="<?php echo esc_url(wp_lostpassword_url()); ?>" title="<?php _e('¿Olvidaste tu Contraseña?','wpdance');?>"><?php _e('¿Olvidaste tu Contraseña?','wpdance');?></a>
						</div>
						<div class="form_wrapper_footer">
							<span><?php _e('¿Nuevo Cliente?','wpdance');?></span><span><a href="<?php echo $register_url; ?>"><?php _e('Registrarse','wpdance');?></a></span>
						</div>
					</div>	
				<?php else: ?>	
					<span class="my_account_wrapper"><a href="<?php echo $profile_url; ?>" title="<?php _e('Mi Cuenta','wpdance');?>"><?php _e('Mi Cuenta','wpdance');?></a></span>
					<span class="logout_wrapper"><a href="<?php echo wp_logout_url( get_permalink() ); ?>" title="<?php _e('Salir','wpdance');?>"><?php _e('Salir','wpdance');?></a></span>
				<?php
					endif
				?>
			</div>
