		...
		<div class="wd_tini_cart_wrapper">
				...
				<span class="cart_size">
					...
					<span class="cart_size_value_head" id="<?php echo $_cart_size_id; ?>">
						<span class="cart_text">
							<span class="text"><?php _e('Mi Carrito','wpdance');?></span>
			...
			<div class="cart_dropdown drop_down_container">
				...
				<div class="dropdown_header">
					<h4><a href="<?php echo WC()->cart->get_cart_url();?>"><?php _e('bolsa de compras','wpdance');?></a></h4>
						<span class="cart_dropdown_size <?php if( $_cart_empty ) echo "size_empty";?>">
							<label>	
								...
								<?php else : ?>
									<?php _e('No tienes artículos en tu carrito.','wpdance');?>
								<?php endif;?>
							</label>
						</span>
				</div>
				...
				<div class="dropdown_body">
					<span class="head_msg"><?php _e('Carrito de compras','wpdance');?></span>
								...
								<li class="<?php echo $_cart_li_class = ($_index == 0 ? "first" : ($_index == count($_cart_array) - 1 ? "last" : "")) ?>">
									...
									<div class="cart_item_wrapper">	
										...
										<a href="<?php echo get_permalink( $cart_item['product_id'] ); ?>">
											...
											<?php
												echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf('<a href="%s" class="remove" title="%s">&times;</a>', esc_url( WC()->cart->get_remove_url( $cart_item_key ) ), __( 'Quitar este artículo', 'wpdance' ) ), $cart_item_key );
										?>
									</div>
								</li>
