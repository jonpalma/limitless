	...
	?>
			<div class="wd_mobile_account <?php echo wd_is_woocommerce()== false ? "full":"" ?>">
				<?php if(!is_user_logged_in()):?>
					...
					<a class="sign-in-form-control" href="<?php echo $myaccount_page_url;?>" title="<?php _e('Ingresar/Registrarse','wpdance');?>">
						<span><?php _e('ingresar / Registrarse','wpdance');?></span>
					</a>
					<span class="visible-xs login-drop-icon"></span>			
				<?php else:?>		
					<a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="<?php _e('Mi Cuenta','wpdance'); ?>">
		...
		<div class="mobile_cart_container visible-xs <?php echo wd_is_woocommerce()== false ? "woo-hidden":"" ?>">
			...
			<?php
				...
				<span class="cart_size">
					<a href="<?php echo WC()->cart->get_cart_url();?>" title="<?php _e('Ver tu bolsa de compras','wpdance');?>">
						<span class="ic-bag"></span>
					
					<!--<span class="cart_division">/</span>-->
					<span class="cart_size_value_head" id="<?php echo $_cart_size_id; ?>">
						<span class="cart_text">
						<?php _e('Mi carrito','wpdance'); ?>
						</span>
				...
				<div class="header-top-container container">
					...
					<div class="left-header-top-content">
						...
						<?php if($smof_data['wd_phone'] !==""): ?>
							<div class="phone-text"><?php _e('Teléfono: ', 'wpdance'); echo $smof_data['wd_phone'] ?></div>
						<?php endif; ?>
						
						<?php if($smof_data['wd_hotline'] !=="" ): ?>
							<div class="hotline-text"><?php _e('Ayuda: ', 'wpdance'); echo $smof_data['wd_hotline'] ?></div>
						<?php endif; ?>
					</div>
